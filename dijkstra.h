...
//
// Copyright (C) 2019 Zhongshi Jiang <jiangzs@nyu.edu> and 2014 Olga Diamanti <olga.diam@gmail.com>
//
...
namespace igl {
  ...
  // Dijkstra's algorithm for shortest paths on a mesh, with multiple targets.
  // Adapted from http://rosettacode.org/wiki/Dijkstra%27s_algorithm .
  //
  // Inputs:
